...
LANG_MAP = {
    "日本語": {
        ...
        "disclaimer": "📌 本解析結果は、MS AI Labが独自に開発したAIアルゴリズムによる抽出サンプルです。システムの信頼性担保のため、東証プライム上場の主要100社に厳密に限定して掲載しています。実運用においては、全上場銘柄（約3,800社）を対象とした網羅的解析を実施しています。",
        "footer_1_head": "**【運営組織】**",
...
# --- 3. 厳選100銘柄実名データベース (自動生成ロジック完全廃止) ---
@st.cache_data
def get_verified_universe():
    # 実在する100社の手動定義リスト (ダブリ・ダミーなし)
    data = [
        ...
        ('8053.T', '住友商事', 'Sumitomo', '卸売業', 'Trading', 12.0, 4.1, 30.0, 3300),
        ...
        ('9984.T', 'ソフトバンクG', 'SoftBank G', '情報・通信', 'Telecom', 10.0, 0.6, 15.0, 8600),
        ...
        ('6752.T', 'パナソニック', 'Panasonic', '電気機器', 'Electronics', 9.5, 2.8, 35.0, 1400),
        ...
        ('6201.T', '豊田自動織機', 'Toyota Indus', '機械', 'Machinery', 9.2, 2.5,
