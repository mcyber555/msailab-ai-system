...
LANG_MAP = {
    "日本語": {
        ...
        "min_roe": "要求ROE (%)", "min_yield": "利回り (%)", "max_payout": "許容性向 (%)",
        ...
        "f2_h": "**【AIテクノロジー】**", "f2_b": "ランダムフォレストを採用。財務指標を多角解析し、投資効率を最大化する独自スコアを算出します。",
    ...
    "English": {
        ...
        "param_desc": "💡 **Logic**\n\n1. **Yield 3.0%+**: Income focus.\n2. **Payout 120.0%-**: Sustainability.\n3. **ROE 6.0%+**: Efficiency.",
        "min_roe": "Required ROE (%)", "min_yield": "Div. Yield (%)", "max_payout": "Max Payout (%)",
        ...
        "disclaimer": "📌 Note: Sample analysis. 100 companies are selected for demo. Actual operations scan all 3,800 TSE stocks.",
...
def get_verified_data():
    # 完全に実在する東証プライム100社の手動検証データ
    # Ticker, 日名, 英名, 業界日, 業界英, ROE, 利回り, 性向, 終値
    d = [
        ...
        ('7203.T','トヨタ自動車','Toyota','輸送用機器','Auto',11.5,2.8,30.5,2650),
        ...
        ('6201.T','豊田自動織機','T-Indus','機械','Machinery',9.2,2.5,32.0,13000),
        ...
        ('8015.T','豊田通商','T-Tsusho','卸売業','Trading',14.2,3.1,28.0,9500),
        ...
        ('4021.T','日産化学','N-Chem','化学','Chemicals',15.2,3.1,45.0,5200),
